                    ...
                    <div className="hero-inner">
                        ...
                        <div className="hero-top">
                            <div className="hero-top-desc">
                                <p>{`"At Cognetz, we hold that creativity sparks innovation. As a full-spectrum creative firm, we excel in converting ambitious ideas into engaging results."`}</p>
                            </div>
                        </div>
