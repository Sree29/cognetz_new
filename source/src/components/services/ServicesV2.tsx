            ...
            <div className="service-sec service-sec-2" id="services">
                <div className="custom-container">
                    <div className="section-header">
                        ...
                        <AnimatedText>
                            At Cognetz, we are guided by an unyielding dedication to excellence, transparent collaboration, and strategic innovation. These principles form the bedrock of our culture, empowering us to build impactful digital strategies that deliver measurable success and scale businesses.
                        </AnimatedText>
                    </div>
                </div>
