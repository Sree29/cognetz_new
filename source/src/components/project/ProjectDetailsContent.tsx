            ...
            <div className="project-single-wrap">
                <div className="project-single-header">
                    <div className="section-header">
                        ...
                        <AnimatedText>
                            Founded on the principles of creativity, collaboration, and excellence, Cognetz is a diverse team of industry experts dedicated to delivering outstanding results...
                        </AnimatedText>
                    </div>
                </div>
