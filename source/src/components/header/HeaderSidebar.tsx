...
const HeaderSidebar = ({ isSidebarActive: propActive, setIsSidebarActive: propSetActive }: HeaderSidebarProps) => {
    const [localActive, setLocalActive] = useState(false);
    const isSidebarActive = propActive !== undefined ? propActive : localActive;
    const setIsSidebarActive = propSetActive || setLocalActive;
